from sofilmes.api.schemas.user_schema import (LoginUserInput, RegisterUserInput,
    RegisterUserResponse, UserOutput)
...
@router.post("/register", response_model=RegisterUserResponse, summary="Registrar novo usuário",
...
@router.post("/login", response_model=UserOutput, summary="Fazer o Login do usuário",
...
@router.post("/logout",summary="Fazer o Logout do usuário",
